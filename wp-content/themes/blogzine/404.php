...
<section class="overflow-hidden">
	<div class="container">
      ...
      <div class="col-md-9 text-center mx-auto my-0 my-md-5 py-0 py-lg-5 position-relative z-index-9">
        ...
        <h2><?= get_field('error-404-title',16) ?></h2>
        <p><?= get_field('error-404-text',16) ?></p>
        <a href="/" class="btn btn-danger-soft mt-3"><i class="fas fa-long-arrow-alt-left me-3"></i><?= get_field('error-404-btn-name',16) ?></a>
      </div>
    </div>
	</div>
</section>
